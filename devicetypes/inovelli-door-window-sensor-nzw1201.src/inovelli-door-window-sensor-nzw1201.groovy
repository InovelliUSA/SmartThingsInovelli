...
metadata {
    definition (name: "Inovelli Door/Window Sensor NZW1201", namespace: "InovelliUSA", author: "Eric Maycock", ocfDeviceType: "x.com.st.d.sensor.contact", vid: "generic-motion") {
